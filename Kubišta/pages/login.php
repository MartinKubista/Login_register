...
<?php $message = isset($_GET["message"]) ? $_GET["message"] : "";?>
  ...
  <form action="../scripts/login_script.php" method="post">
        <div class="container">
          ...
          <p><button type="submit" class="btn btn-outline-success">Prihlasit sa</button>
          <p class="text-danger"><?php echo $message ?></p>
          <br>
          <hr>
          <p style="font-weight: bolder;">Nemate ucet? <p><a href="register.php" class="btn btn-outline-danger">Zaregistrujte sa</a></p>
        </div>     
      </form>
  </main>
